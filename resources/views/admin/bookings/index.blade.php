                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            <tr>
                                ...
                                <th>@changeLang('User Username')</th>
                                <th>@changeLang('User Email')</th>
                                <th>@changeLang('User Phone')</th>
                                <th>@changeLang('Created At')</th>

                            </tr>
                            @php
                                $bookings2 = DB::table('appointments')->get();
                            ...
                            @forelse ($bookings2 as $key => $booking)
                                <tr>
                                    ...
                                    ->where('id', $booking->b_id)
                                    ->pluck('mobile')->first();
                                    $uusername = DB::table('users')
                                    ->where('id', $booking->user_id)
                                    ->pluck('username')->first();
                                    $uemail = DB::table('users')
                                    ->where('id', $booking->user_id)
                                    ->pluck('email')->first();
                                    $umobile = DB::table('users')
                                    ->where('id', $booking->user_id)
                                    ->pluck('mobile')->first();
                                    @endphp
                                    <td>{{ $username }}</td>
